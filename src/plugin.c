...
#define PLUGIN_NAME "Meta Data"
#define PLUGIN_AUTHOR "Bluscream"
#define PLUGIN_VERSION "1.0"
#define PLUGIN_CONTACT "admin@timo.de.vc"
#define PLUGIN_DESCRIPTION "Shows you the Meta Data of clients."
...
const char* ts3plugin_name() {
	...
	if(!result) {
		const wchar_t* name = L"Meta Data";
	...
	switch (type) {
		case PLUGIN_CLIENT:
			...
			*data = (char*)malloc(INFODATA_BUFSIZE * sizeof(char));
			snprintf(*data, INFODATA_BUFSIZE, "%s", metaData);
